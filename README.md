...
*   **Zero External Dependencies**: Ships as a static binary with SQLite compiled in and the admin SPA embedded natively.
...
*   `admin`: The self-hosted Leptos frontend SPA, compiled in and served natively.
